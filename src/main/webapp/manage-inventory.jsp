...
<body>
	...
	<fieldset id="fsCreateProd">
		...
		<label>Product Name: <input type="text" name="newName"
			value="" id="newName" class="newProduct" />
		</label> <br /> <label>Price: <input type="text" name="newPrice"
			value="" id="newPrice" class="newProduct" />
		</label> <br /> <label>Quantity: <input type="text"
			name="newQuantity" value="" id="newQuantity" class="newProduct" />
		</label> <br /> <label>Product Description: <textarea rows="4"
				name="newDescription" id="newDescription" class="newProduct"></textarea>
		</label> <br />
		<form id="upload-form" class="upload-box" action="UploadProductImage" name="submit"
